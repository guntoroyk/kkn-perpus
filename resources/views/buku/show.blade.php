                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample">
                            ...
                            <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
                                <label for="kode_huruf" class="col-md-4 control-label">Kode Huruf</label>
                                <div class="col-md-6">
                                    <input id="kode_huruf" type="text" class="form-control" name="kode_huruf" value="{{ $data->kode_huruf }}" readonly>
                                    @if ($errors->has('kode_huruf'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('kode_huruf') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('lokasi') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="lokasi" class="form-control" name="lokasi" value="{{ $data->lokasi }}" readonly>
